...
const WideArticleRowCard = ({ article }) => {
  ...
  return (
    ...
    >
      {/* Image on Left */}
      {imageUrl && (
        <div className="w-32 sm:w-40 md:w-48 flex-shrink-0 overflow-hidden bg-gray-100">
      ...
      <div className="flex-1 flex flex-col p-3 sm:p-4 min-w-0">
        {/* Category */}
        {category && (
          <span className="inline-block px-2 py-0.5 bg-blue-600 text-white text-xs font-medium rounded-full mb-2 w-fit">
            {category}
          </span>
        )}
