  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 p-4 flex gap-4 items-start">
      ...
      <div className="flex-1 min-w-0">
        {article.category && (
          <span className="inline-flex w-fit px-2.5 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-700 mb-2">
            {article.category}
          </span>
        )}
        ...
        <div className="mt-3 flex items-center gap-3 flex-wrap">
          ...
          <button
            ...
            className="ml-auto whitespace-nowrap inline-flex items-center gap-1 px-4 py-2 text-sm font-semibold rounded-lg border border-blue-200 text-blue-700 hover:bg-blue-50 transition-colors"
          >
            Continue reading
          </button>
        </div>
